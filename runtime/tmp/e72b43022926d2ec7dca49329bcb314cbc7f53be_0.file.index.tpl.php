                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <div class="dt-buttons">
                                ...
                                <a href="<?php echo $_smarty_tpl->tpl_vars['products_add_index']->value;?>
">
                                    <button class="dt-button buttons-copy buttons-html5" tabindex="0" aria-controls="copy-print-scroll" type="button">
                                        <span>添加</span>
                                    </button>
                                </a>
                                <a href="javascript:void(0);" onclick="download_all_export('<?php echo $_smarty_tpl->tpl_vars['token']->value;?>
')">
                                    <button class="dt-button buttons-copy buttons-html5" tabindex="0" aria-controls="copy-print-scroll" type="button">
                                        <span>导出漏洞报告</span>
                                    </button>
                                </a>
                                <a href="javascript:void(0);" onclick="download_repair_all_export('<?php echo $_smarty_tpl->tpl_vars['token']->value;?>
')">
                                    <button class="dt-button buttons-copy buttons-html5" tabindex="0" aria-controls="copy-print-scroll" type="button">
                                        <span>导出复测报告</span>
                                    </button>
...
>
        ...
        function download_export(id,token)
        {
            layer.open({
                ...
                btn: ['确定'],
                content: '' +
                '<div class="field-wrapper"><div class="field-wrapper"><select class="select-single js-states" title="" data-live-search="true" id="range">'+'<?php echo $_smarty_tpl->tpl_vars['template']->value;?>
'+'</select></div></div>',
                yes: function (index,layero) {
                    if($('#range').val()){
                        $.post("<?php echo $_smarty_tpl->tpl_vars['products_download_index']->value;?>
",{
                            id:id,
                            token:token,
                            path:$('#range').val(),
...
'+'</select></div></div>',
                yes: function (index,layero) {
                    if($('#range').val()){
                        $.post("<?php echo $_smarty_tpl->tpl_vars['products_repair_download_index']->value;?>
",{
                            id:data,
                            token:token,
                            path:$('#range').val(),
            ...
            layer.prompt({
                ...
                if(value){
                    if(value > 10){
                        ...
                        console.dir(value)
                        $.post("<?php echo $_smarty_tpl->tpl_vars['menu']->value['products_index'];?>
",{
                            num:value,
                        },function(data){
                            if(data.status == '1'){
        ...
        function _init(company)
        {
            $("#index").DataTable({
                ...
                "destroy": true,
                "ajax": {
                    "url": "<?php echo $_smarty_tpl->tpl_vars['menu']->value['products_index'];?>
",
                    "type":"POST",
                    "data":{
                        "company":company,
                ...
                "columns": [
                    ...
                    },
                    {
                        "data": function (row, type, val, meta) {
                            ...
                            text += '<a href="javascript:void(0);" onclick="download_export(\''+row.session+'\',\'<?php echo $_smarty_tpl->tpl_vars['token']->value;?>
\')" data-toggle="tooltip" data-placement="top" title="" data-original-title="导出"><i class="icon-download1 text-info"></i>&nbsp;</a>'
